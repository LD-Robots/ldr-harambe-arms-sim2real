...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument('object_radius', default_value='0.03035',
        ...
        DeclareLaunchArgument('pick_y', default_value='0.35',
                              description='Pick Y position'),
        DeclareLaunchArgument('pick_z', default_value='0.175',
                              description='Pick Z position'),
        DeclareLaunchArgument('place_x', default_value='0.45',
                              description='Place X position (5 cm toward the robot from the pick)'),
        DeclareLaunchArgument('place_y', default_value='-0.35',
                              description='Place Y position (same as pick)'),
        DeclareLaunchArgument('place_z', default_value='0.175',
                              description='Place Z position (same as pick)'),
